...
_do-release: clean test-cov security lint
	...
	droid exec "Analyze git history and generate (if missing) or update changelog. There are tags in the git history - take look at the changes between the tags and generate/update changelog for each version." --auto medium
